...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/types-tabulate-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13174&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/types-tabulate-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `types-tabulate` can be installed with:

```
conda install types-tabulate
```

It is possible to list all of the versions of `types-tabulate` available on your platform with:
